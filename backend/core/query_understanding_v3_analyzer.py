    ...
    try:
        ...
        async def invoke() -> Any:
            ...
            try:
                ...
                if remaining <= 0.1:
                    raise TimeoutError("query_understanding_v3_deadline_exhausted") from schema_error
        ...
        response = await asyncio.wait_for(invoke(), timeout=configured_timeout_seconds)
